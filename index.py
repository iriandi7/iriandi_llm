...
with st.sidebar:
    ...
    if st.button('Generate'):
        ...
        health_keywords = ['health', 'medical', 'wellness', 'nutrition', 'fitness', 'human']
        if any(keyword in formatted_prompt.lower() for keyword in health_keywords):
            ...
            st.warning("Please enter a health-related prompt (e.g., health, medical, wellness, nutrition, fitness).")
